        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.2:3000/api/v1/users/login",
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "http://127.0.0.2:3000/api/v1/users/logout"
            });
          case 3:
            res = _context2.sent;
            if (res.data.status = "success") {
...
exports.displyMap = void 0;
console.log("hello from clint side ");
// abdullahallakib
// password REG-1514834882akib

var displyMap = function displyMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYWJkdWxsYWhhbGxha2liIiwiYSI6ImNsYm91d2Z0dzAyM2Mzb215YWZocGFwYXQifQ.Et5Z8bUi8pypeq4C-32lvA";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe("pk_test_51MHUckHMhKGG4I9MFxX61qjC2ewRKuJfFdjTh8b1VUbccAKzfEHqEauxmIId3RZknbRRqEesvFsJIuMHrt3Y4EBe00WkwRzf0E");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.2:3000/api/v1/booking/checkout-session/".concat(tourId));
          case 3:
...
exports.updatedDataSetting = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var updatedDataSetting = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "http://127.0.0.2:3000/api/v1/users/updatemyPassword" : "http://127.0.0.2:3000/api/v1/users/updateme";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
  ...
  return function updatedDataSetting(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.updatedDataSetting = updatedDataSetting;
...
if (userDataForm) {
  userDataForm.addEventListener("submit", function (e) {
    ...
    (0, _updateSetting.updatedDataSetting)(form, "data");
  });
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSetting.updatedDataSetting)({
